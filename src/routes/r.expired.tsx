...
export const Route = createFileRoute("/r/expired")({
  head: () => ({
    meta: [
      { title: "Canal fermé — CipherRoom" },
      { name: "description", content: "Ce canal chiffré s'est refermé." },
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center px-6 overflow-hidden scan-lines">
      ...
      <div className="relative z-10 max-w-md text-center">
        ...
        <h1
          className="font-serif text-5xl text-bone mb-4 italic glitch-text"
          data-text="Le canal s'est refermé."
        >
